    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                <span class="material-symbols-outlined align-middle me-1 text-primary">campaign</span>
                Gestión de Comunicados y Cartelera Digital
            </h1>
            <p class="text-muted small mb-0">Publicación de avisos generales o segmentados por edificio y apartamento.</p>
        </div>
        <button type="button" class="btn btn-primary font-weight-bold d-inline-flex align-items-center gap-1 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalNuevoComunicado">
