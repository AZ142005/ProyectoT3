    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0 text-dark fw-bold">
                <span class="material-symbols-outlined align-middle me-1 text-primary">account_balance</span>
                Motor de Conciliación Bancaria Inteligente
            </h1>
            <p class="text-muted small mb-0">Cruce automatizado en 3 niveles entre extractos bancarios y pagos reportados.</p>
        </div>
        <div class="d-flex gap-2">
            <button type="button" class="btn btn-primary fw-bold d-inline-flex align-items-center gap-1 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalImportarExtracto">
