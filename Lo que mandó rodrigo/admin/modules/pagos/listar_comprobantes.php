...
<head>
    ...
    <title>Todos los Comprobantes</title>
    <style>
    ...
    <div class="main-content">
        <div class="header-admin">
            <div style="display:flex;align-items:center;gap:15px;">
                ...
                <h1>Todos los <span>Comprobantes</span></h1>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3>Comprobantes Enviados por Residentes</h3>
                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <strong><?= htmlspecialchars($c['residente']) ?></strong>
                                    <br><small style="color:#5a7a6a;"><?= htmlspecialchars($c['cedula']) ?></small>
                                </td>
                                ...
                                <td>
                                    <?php if ($c['estado'] == 'pendiente'): ?>
                                        <a href="verificar_comprobante.php?id=<?= $c['id'] ?>" class="btn btn-info btn-sm">Verificar</a>
                                    <?php else: ?>
                                        <span style="color:#5a7a6a;font-size:11px;">Procesado</span>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
